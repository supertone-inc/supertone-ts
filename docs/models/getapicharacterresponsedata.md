...
```typescript
import { GetAPICharacterResponseData } from "@supertone/supertone/models";

let value: GetAPICharacterResponseData = {
  voiceId: "<voice-id>",
  name: "Agatha",
  description: "",
  age: "young-adult",
...
| `description`                                                                                                                                | *string*                                                                                                                                     | :heavy_minus_sign:                                                                                                                           | Description of the voice                                                                                                                     |                                                                                                                                              |
...
| `models`                                                                                                                                     | *string*[]                                                                                                                                   | :heavy_check_mark:                                                                                                                           | Models available for the voice                                                                                                               | [<br/>"sona_speech_1",<br/>"sona_speech_2",<br/>"sona_speech_2t",<br/>"sona_speech_2_flash",<br/>"supertonic_api_1",<br/>"sona_speech_3t",<br/>"supertonic_api_3"<br/>] |
