 ...
 */
export function customVoicesSearchCustomVoices(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchCustomVoicesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/custom-voices/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomVoiceListResponse$inboundSchema),
