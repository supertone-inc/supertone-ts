 ...
 */
export function customVoicesDeleteCustomVoice(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteCustomVoiceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/custom-voices/{voice_id}")(pathParams);
